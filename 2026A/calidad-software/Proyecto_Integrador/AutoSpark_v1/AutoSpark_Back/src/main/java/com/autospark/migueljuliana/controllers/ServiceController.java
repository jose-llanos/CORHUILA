...
public class ServiceController {
    ...
    public void deleteService(@PathVariable Long id) {
        ...
        // ERROR LOW: Código comentado que debería ser eliminado
        // CarWashService service = service.findById(id);
        // if (service == null) {
        //     return ResponseEntity.notFound().build();
        // }
        // List<Reservation> reservations = reservationService.findByServiceId(id);
