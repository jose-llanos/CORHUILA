...
public class ReservationServiceImpl implements IReservationService {
    ...
    public synchronized Reservation save(Reservation reservation) {
        ...
        // ERROR MEDIUM: Thread.sleep en método sincronizado
        try {
            Thread.sleep(5000); // Bloquea el hilo por 5 segundos
    ...
    public List<ReservationUserDTO> getReservationsWithUsers() {
        ...
        // ERROR MEDIUM: Posible memory leak - cargar todo en memoria sin límite
