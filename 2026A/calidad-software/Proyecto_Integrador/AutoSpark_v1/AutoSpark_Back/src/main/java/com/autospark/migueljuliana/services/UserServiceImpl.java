...
public class UserServiceImpl implements IUserService {
    ...
    // ERROR LOW: Constantes no utilizadas
    private static final int MAX_LOGIN_ATTEMPTS = 5;
    private static final long LOCKOUT_DURATION = 30 * 60 * 1000; // 30 minutos en ms
    ...
    public void update(User user, Long id) {
        ...
        // ERROR LOW: Este método no hace nada significativo
        // Solo tiene el log y el resto está comentado
    ...
    */
    ...
    public void sendEmail(String to, String subject, String body) throws MessagingException {
        ...
        // ERROR MEDIUM: Resource leak - no se cierra el resource
        ...
        // Falta: message = null o gestión adecuada
